...
import { MdDashboard, MdOutlineHttp } from 'react-icons/md';
...
import { DashboardProvider } from '@raondata/dashboard-module';
...
const mainMenuRouteConfig: {
  ...
  },
  {
    ...
    icon: MdDashboard,
    element: (
      <DashboardProvider items={dashboardConfig.items}>
        <DashboardPage />
      </DashboardProvider>
    ),
  },
